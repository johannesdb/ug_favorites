<?php
/**
 * Plugin Name: UG Simple Favorites (Optimized)
 * Plugin URI: https://github.com/JERES-ORG/favorites
 * Description: Optimized version - reduced AJAX response size
 * Version: 3.2.6-optimized
 * ...
 */
